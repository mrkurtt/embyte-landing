...
export function PreviewFields({
  ...
  const defaultFields = [
    ...
    { label: "Who's attending?", type: 'radio' as const, options: ['Just me', 'Me + 1'], required: true },
    { label: "Your guest's name", type: 'text' as const, placeholder: 'Full name of the person accompanying you', required: false },
